...
const products = [
    {
        image: "https://images.unsplash.com/photo-1517621771456-94400b855f7b?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
...
products.forEach((prod, idx) => {
    clutter += ` <div data-index=${idx} class="border rounded-lg shadow-lg p-4">
          ...
          <div class="mt-4">
            ...
            <div class="text-red-500 text-sm line-through">$${prod.price * 2}</div>
